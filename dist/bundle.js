...
function timer(divName) {
    ...
    btnStart.addEventListener('click', function () {
        var dur = moment.duration(+time.innerText, 'minutes');
        var interval = moment.duration(1, 'seconds');
        ...
        setInterval(function () {
            if (dur.minutes() > 0 || dur.seconds() > 0) {
                ...
                time.innerText = dur.minutes() + ":" + (dur.seconds() > 9 ? dur.seconds() : '0' + dur.seconds());
            } else {
                time.innerText = '0';
